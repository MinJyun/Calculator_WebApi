...
namespace Calculator_WebApi.Button
{
    ...
    /// 乘或除的按鍵
    /// </summary>
    public class CrossAndDivide:ButtonBase
    {
        /// <summary>
        /// 按鍵名稱
        /// </summary>
        ...
        public CrossAndDivide(string buttonName)
        {
            Button = buttonName;
            IsNumber = false;
        ...
        {
            //遇到+-也會停下
            while (presentNode.TopNode != null && presentNode.TopNode.Prioraty < 3)
            {
                presentNode = presentNode.TopNode;
            }

            Node temp = new Node(Button, 2);
